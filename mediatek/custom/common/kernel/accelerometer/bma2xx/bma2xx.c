...
static struct i2c_board_info __initdata bma_i2c_info = {
	I2C_BOARD_INFO(BMA_DEV_NAME, BMA_I2C_ADDRESS(BMA222, PIN_HIGH))
};
...
static ssize_t show_status_value(struct device_driver *ddri, char *buf)
{
	...
	len += snprintf(buf+len, PAGE_SIZE-len, "i2c addr:%#x,ver:%s\n",
		obj->client->addr, BMA_DRIVER_VERSION, obj->hw->i2c_num, obj->hw->direction, obj->hw->power_id, obj->hw->power_vol);
